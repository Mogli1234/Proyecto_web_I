@extends('layouts.app')
@section('content')
    <form class="form-horizontal form-label-left" method="POST" novalidate action="/Output/{{$edited_mail[0]->id}}">
        ...
        <div>
            <button type="submit" class="btn btn-default">Update Mail</button>
            <a href="/Output"><input type="button" class="btn btn-default" value="Cancel"></a>
        </div>
